...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
        ...
        <div class="sidebar-brand-text mx-3"><img src="logo.jpg" style="width:50px; height:50px" alt=""> Sia Wali</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtility" class="collapse" aria-labelledby="headingUtility" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <h6 class="collapse-header">Custom Utilities:</h6> -->
    ...
    <li class="nav-item">
        ...
        ?>
        <div id="collapseSlider" class="collapse" aria-labelledby="headingLogo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <h6 class="collapse-header">Custom Utilities:</h6> -->
