...
if (isset($_POST['add_product'])) {
    if (!empty($_POST['category']) && !empty($_POST['sous_cat']) && !empty($_POST['title']) && !empty($_POST['caracterisque']) && !empty($_POST['description']) && !empty($_POST['quantity']) && !empty($_POST['price']) && !empty($_POST['color']) && !empty($_POST['size']) && !empty($_FILES['name_url']) && !empty($_FILES['name_url1']) && !empty($_FILES['name_url2'])) {
