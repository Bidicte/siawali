...
if(isset($_POST['updateUser'])){
    if(isset($_POST['update_firstname']) && isset($_POST['update_lastname']) && isset($_POST['update_phone']) && isset($_POST['update_email']) && isset($_POST['update_address']) && isset($_POST['update_login']))
    {
        ...
        $updateUsers = $bdd->prepare('UPDATE users SET user_firstname=?, user_lastname=?, user_phone = ?, user_email = ?, user_address = ?, user_login = ? WHERE user_id = ?');        
        $updateUsers->execute(array($new_firstname, $new_lastname, $new_phone, $new_email, $new_address, $new_login, $id));
