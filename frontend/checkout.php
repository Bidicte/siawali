...
//     $product = $product_query->fetchAll(PDO::FETCH_ASSOC);

//     $update_quantity = $bdd->prepare("UPDATE product SET product_quantity = product_quantity - 1 WHERE product_id = ? LIMIT 1");
                                ...
                                <div class="item left styled">
                                    ...
                                    <?php if (isset($_SESSION['auth'])) { ?>
                                        <p>
                                            ...
                                            <input type="text" name="nom" id="nom" value="<?= $_SESSION['customer_lastname'] . " " . $_SESSION['customer_firstname'] ?>">
                                        </p>
                                    <?php } ?>
                                    <p>
                                        <label for="email">Email<span></span></label>
                                        <input type="email" name="email" id="email" value="<?= $_SESSION['customer_email'] ?>">
                                    </p>
                                    <p>
