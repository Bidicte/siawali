    ...
    if(isset($_POST['scope'])){
        ...
        switch($scope)
        {
            case "add":
                ...
                {
                    $insertProductInCart = $bdd->query("INSERT INTO cart2(customer_id,product_id,product_quantity,product_size, product_price, cart_date) VALUES('$customer_id','$product_id','$product_quantity','$product_size','$product_price',NOW())");
